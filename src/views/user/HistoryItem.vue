<template>
  <div class="collectItem" @click="deleteItem">
    ...
    <el-button class="el-button_wrapper" type="primary" size="large" @click="deleteItem()">删除</el-button>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    deleteItem() {
      console.log(this.item.tmdbId);
      request.delete("/user/history/" + this.item.tmdbId,
