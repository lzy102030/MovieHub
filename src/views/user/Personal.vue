    ...
    <div>
        <div class="PersonTop">
            <div class="PersonTop_img">
                <img v-image-preview :src=userUrl />
            </div>
                ...
                <div class="user_text">
                    ...
                    <div class="user_anniu">
                        <el-button class="el-icon-edit" v-if="this.$route.params.id === this.$store.state.id" type="primary"
                            size="medium" @click="edit" plain>编辑</el-button>
                        <el-button v-else type="primary" size="medium" icon="el-icon-check" v-text="'关注'
                            "></el-button>
                    </div>
                </div>
                <div class="user_num">
                    <div style="cursor: pointer">
                        <div class="num_number">8</div>
